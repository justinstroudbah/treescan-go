...
type ApexParserListener interface {
	...
	// EnterTriggerBlockMember is called when entering the triggerBlockMember production.
	EnterTriggerBlockMember(c *TriggerBlockMemberContext)
	...
	// EnterTriggerMemberDeclaration is called when entering the triggerMemberDeclaration production.
	EnterTriggerMemberDeclaration(c *TriggerMemberDeclarationContext)
	...
	// EnterAccessLevel is called when entering the accessLevel production.
	EnterAccessLevel(c *AccessLevelContext)
	...
	EnterNewExpression(c *TNewExpressionContext)
	...
	// EnterVoidPrimary is called when entering the voidPrimary production.
	EnterVoidPrimary(c *VoidPrimaryContext)
	...
	// EnterSoslWithClause is called when entering the soslWithClause production.
	EnterSoslWithClause(c *SoslWithClauseContext)
	...
	// ExitTriggerBlockMember is called when exiting the triggerBlockMember production.
	ExitTriggerBlockMember(c *TriggerBlockMemberContext)
	...
	// ExitTriggerMemberDeclaration is called when exiting the triggerMemberDeclaration production.
	ExitTriggerMemberDeclaration(c *TriggerMemberDeclarationContext)
	...
	// ExitAccessLevel is called when exiting the accessLevel production.
	ExitAccessLevel(c *AccessLevelContext)
	...
	ExitNewExpression(c *TNewExpressionContext)
	...
	// ExitVoidPrimary is called when exiting the voidPrimary production.
	ExitVoidPrimary(c *VoidPrimaryContext)
	...
	// ExitSoslWithClause is called when exiting the soslWithClause production.
	ExitSoslWithClause(c *SoslWithClauseContext)
